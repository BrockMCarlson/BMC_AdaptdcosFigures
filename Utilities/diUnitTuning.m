function X = diUnitTuning(RESP,STIM,goodfiles)
...
%uContrast = unique(STIM.contrast(~STIM.motion & ~STIM.cued,:));
uContrast(uContrast==0 | isnan(uContrast)) = [];
