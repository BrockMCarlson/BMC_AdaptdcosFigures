%% diIDX_Adapt200vs800_monocX
% taken from diIDX_Adapt200vs800_tstatYaxis
...
flag_saveIDX    = 1;
normalize       = 0;
saveName = 'diIDX_Adapt200vs800_monocX';
...
if ~all((STIM.contrast(find(STIM.adapted)+1,1) == STIM.contrast(STIM.adapted,1)) & ...
        (STIM.tilt(find(STIM.adapted)+1,1) == STIM.tilt(STIM.adapted,1)) & ...
        (STIM.monocular(ADAPTER) == 1))
