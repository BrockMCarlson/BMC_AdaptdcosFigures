function IDX = IDX_iScienceSubmission_onlyI34
...
saveName = 'IDX_iScienceSubmission_onlyI34.mat'; % THIS IS CONTRAST LEVELS OF .41-.75 INCLUSIVE
flag_saveIDX    = true;

global STIMDIR
cd(STIMDIR)
list    = dir(['*_I_*','AUTO.mat']);
anaType = '_AUTO.mat';
