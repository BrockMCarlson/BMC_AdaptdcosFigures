function IDX = IDX_iScienceSubmission_unbalancedContrast
...
saveName = 'IDX_iScienceSubmission_unbalancedContrast.mat'; % THIS IS CONTRAST LEVELS OF .41-.75 INCLUSIVE
anaType = '_AUTO.mat';
flag_saveIDX    = true;
...
if DE == 2 % This puts the dominant eye in the first column and the nde in the 2nd column (I think)
...
for cond = 1:size(conditionarray,1)
    clear trls    
    % get monocular trials - taken at high contrast
    if cond < 5
      trls = I &...
            STIM.eye        == conditionarray(cond,1) &...
            STIM.tilt(:,1)  == conditionarray(cond,2) & ... % We care about the dominant eye
    ...
    elseif cond >= 5 && cond <= 8 % get simultaneous trials
        trls = I &...
            ...
            STIM.soa       == conditionarray(cond,6) & ...
            STIM.monocular == conditionarray(cond,7) & ...
            (SORTED.contrasts(:,1)  <= .5) &... % We want medium or low contrast in DE
            (SORTED.contrasts(:,2)  > .5) ; % We want high contrast in the NDE
