function IDX = IDX_iScienceSubmission_onlyE48
...
saveName = 'IDX_iScienceSubmission_onlyE48.mat'; % THIS IS CONTRAST LEVELS OF .41-.75 INCLUSIVE
flag_saveIDX    = true;

global STIMDIR
cd(STIMDIR)
list    = dir(['*_E_*','AUTO.mat']);
anaType = '_AUTO.mat';
...
load([STIMDIR penetration '.mat'],'STIM')
...
matobj = matfile([STIMDIR penetration anaType]);
